...
export default function CardHome({ animal }) {
    ...
    return (
        ...
        <Link to={`animalHome${animal.id}`} style={{ textDecoration: "none" }}>
            <div className="border border-1 mt-4 rounded-3 shadow" style={cardStyle}>
                <img src={animal.animal_image} alt={animal.nombre} className="img-fluid" />
                <h2 className="mt-2"style={{ fontSize: "24px", textDecoration: "none", color: "#ff914d" }}> {animal.nombre}</h2>
