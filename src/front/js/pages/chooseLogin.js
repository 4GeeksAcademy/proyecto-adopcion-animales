            ...
            <div className="container">
                <div className="row d-flex justify-content-center align-items-center">
                    <div className="col-sm-6">
                        <div className="card border border-1 mt-2 shadow-sm" style={{ backgroundColor: "transparent" }}>
                            <div className='card-body text-center'>
                                ...
                                <Link to="/loginUsuario">
                                    <button type="button" className="btn btn-lg shadow-sm mt-2" style={{ backgroundColor: "#ff914d", textDecoration: "none", color: "black" }}>Iniciar Sesión</button>
                                </Link>
                            </div>
                        </div>
                    </div>
