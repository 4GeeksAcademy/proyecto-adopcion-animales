...
import asociacionImg from '../../../front/img/Asociacion.png';
...
export default function LoginAsociacion() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(process.env.BACKEND_URL + "/api/login_asociacion", {
        method: "POST",
        headers: {
                ...
                <div className="card-body p-4 p-lg-5">
                  <form onSubmit={handleSubmit}>
                    <div className="d-flex align-items-center mb-3 pb-1">
                      <i
                        className="fa-solid fa-house fa-2x me-3"
                        style={{ color: "#FF914D" }}
                      />
                      <h1 className="mb-0">Asociación</h1>
                    </div>
                    {loginError && (
                    ...
                    <div className="pt-1 mb-4">
                      ...
                      <p className="mb-5 pb-lg-2 text-muted">
                        ¿No tienes cuenta?{" "}
                        <a href="/signup2" style={{ textDecoration: "none" }}>
                          Registrate
                        </a>
                      </p>
                  </form>
